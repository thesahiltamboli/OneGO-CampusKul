...
public class AlumniServiceImpl implements AlumniService {
    ...
    public AlumniResponseDTO addAlumni(AlumniRequestDTO requestDTO) {
        ...
        User user =userRepository.findById(requestDTO.getUserId()).orElseThrow(()-> new RuntimeException("User not found of Id: " + requestDTO.getUserId()));
